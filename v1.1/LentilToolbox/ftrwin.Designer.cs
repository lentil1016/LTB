namespace LentilToolbox
{
    partial class ftrwin
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.齿槽深 = new LentilToolbox.TextBoxDoubleFactor(this);
            this.齿胚厚 = new LentilToolbox.TextBoxDoubleFactor(this);
            this.圆柱齿轮齿宽 = new LentilToolbox.TextBoxDoubleFactor(this);
            this.轴段宽度 = new LentilToolbox.TextBoxDoubleFactor(this);
            this.轴段直径 = new LentilToolbox.TextBoxDoubleFactor(this);
            this.圆柱齿轮齿数 = new LentilToolbox.TextBoxIntFactor(this);
            this.圆柱齿轮模数 = new LentilToolbox.TextBoxIntFactor(this);
            this.锥齿轮齿数 = new LentilToolbox.TextBoxIntFactor(this);
            this.大端模数 = new LentilToolbox.TextBoxIntFactor(this);
